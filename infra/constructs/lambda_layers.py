...
class LambdaLayers(Construct):
    def __init__(
        ...
        **kwargs
        ...
        # Define layers
        self.gate_agent_be = self._create_layer(
            f"{stack_name}-gate-agent-be-layer",
            "./assets/layers/gate-agent-be",
        ...
        self.dependencies = self._create_layer_from_requirements(
            ...
            "./assets/layers/gate-agent-be/python",
    ...
    def get_all_layers(self) -> list[_lambda.ILayerVersion]:
        return [self.gate_agent_be, self.dependencies]